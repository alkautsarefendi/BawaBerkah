...
public class ProductsZakatAdapter extends RecyclerView.Adapter<ProductsZakatAdapter.ProductViewHolder> {
    ...
    public ProductsZakatAdapter(Context mCtx, List<ProductWakaf> productList) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.row_campaign_zakat, null);
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View itemView) {
            ...
            btnDonasi = (Button) itemView.findViewById(R.id.btnZakat);
